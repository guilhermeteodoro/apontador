Checker::Application.routes.draw do
  ...
  controller :tasks do
    get 'manager/task/:id'      => 'tasks#show', as: 'task'
    put 'manager/task/:id'      => 'tasks#update', as: 'task'
    get 'manager/task/new'      => 'tasks#new', as: 'new_task'
    post 'manager/task'         => 'tasks#create', as: 'task'
    # get 'manager/tasks'       => 'tasks#index', as: 'task'
